...
<table width="100%" border="0">
  <tr>
	...
	<center><div class="tit"><h2 style="color: #605C5C; ">Inicio de sesión</h2>
	...
	<table border="0" align="center" valign="middle">
		...
		<tr><td><label style="font-size: 14pt; color: #605C5C" ><b>Usuario: </b></label></td>
			<td width=80> <input class="form-group has-success" style="border-radius:15px;" type="text" name="mail" minlength="6" maxlength="30" required ></td></tr>
