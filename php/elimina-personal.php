...
echo '<table class="table table-striped table-condensed table-hover">
	...
	while($registro2 = mysql_fetch_array($registro)){
		echo '<tr>
				...
				<td><a href="../vistas/actualizarpersonal.php?id=('.$registro2['id_personal'].');" class="glyphicon glyphicon-edit"></a> <a href="../vistas/reporte-usuario.php?nombre='.$registro2['Nom_Personal'].';" class="glyphicon glyphicon-th-list"></a> <a href="javascript:eliminarProducto('.$registro2['id_personal'].');" class="glyphicon glyphicon-remove-circle"></a></td>
				</tr>';
	}
echo '</table>';
}
