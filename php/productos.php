...
$pdf->Cell(20, 8, 'ID Servicio', 0);
$pdf->Cell(30, 8, 'Departamento', 0);
$pdf->Cell(60, 8, 'Maestro', 0);
$pdf->Cell(30, 8, 'No. de Copias', 0);
$pdf->Cell(30, 8, 'Clave', 0);
...
while($productos2 = mysql_fetch_array($productos)){
	...
	$pdf->Cell(20, 8,$productos2['id_reg_serv_copiado'], 0);
	$pdf->Cell(30, 8,$productos2['departamento'], 0);
	$pdf->Cell(60, 8, $productos2['maestro'], 0);
	$pdf->Cell(30, 8, $productos2['num_copias'], 0);
